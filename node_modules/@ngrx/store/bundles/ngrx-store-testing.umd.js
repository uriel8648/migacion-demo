(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@ngrx/store'),exports, require('@angular/core'), require('rxjs'), require('@ngrx/store'), require('@angular/core/testing')) :
    typeof define === 'function' && define.amd ? define('@ngrx/store/testing', ['@angular/core','@ngrx/store','exports', '@angular/core', 'rxjs', '@ngrx/store', '@angular/core/testing'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ngrx.store,(global.ngrx = global.ngrx || {}, global.ngrx.store = global.ngrx.store || {}, global.ngrx.store.testing = {}), global.ng.core, global.rxjs, global.ngrx.store, global.ng.core.testing));
}(this, (function (ɵngcc0,ɵngcc1,exports, core, rxjs, store, testing) { 'use strict';
...
MockState.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: MockState, factory: function (t) { return MockState.ɵfac(t); } });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(MockState, [{
...
MockStore.ɵfac = function MockStore_Factory(t) { return new (t || MockStore)(ɵngcc0.ɵɵinject(MockState), ɵngcc0.ɵɵinject(ɵngcc1.ActionsSubject), ɵngcc0.ɵɵinject(ɵngcc1.ReducerManager), ɵngcc0.ɵɵinject(store.INITIAL_STATE), ɵngcc0.ɵɵinject(MOCK_SELECTORS)); };
MockStore.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: MockStore, factory: function (t) { return MockStore.ɵfac(t); } });
...
MockReducerManager.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: MockReducerManager, factory: function (t) { return MockReducerManager.ɵfac(t); } });
